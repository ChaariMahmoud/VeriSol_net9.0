...
> - CHAARI Mahmoud : Research Assistant at Team MoVe
> - LIP6 (Laboratoire d'Informatique de Paris 6)
> - Sorbonne Université - CNRS
> This project is a fork of the original [Microsoft VeriSol](https://github.com/microsoft/verisol) repository.

- Install **.NET SDK** (version **9.0**) for Windows/Linux/OSX from [here](https://dotnet.microsoft.com/download/dotnet/9.0)

The following are dynamically installed at VeriSol runtime (the first time only):
- [Solidity compiler](https://github.com/ethereum/solidity/releases/tag/v0.5.10) (for Windows and Linux only)
- [Z3 theorem prover](https://github.com/Z3Prover/z3/releases)
- [Corral](https://github.com/boogie-org/corral) and [Boogie](https://github.com/boogie-org/boogie) verifiers
...
Before running VeriSol, make sure to install the following dependencies:
...
3. Add .NET tools to your PATH:
   - For Linux/macOS (bash/zsh):
     ```bash
     echo 'export PATH="$PATH:$HOME/.dotnet/tools"' >> ~/.bashrc  # for bash
     echo 'export PATH="$PATH:$HOME/.dotnet/tools"' >> ~/.zshrc   # for zsh
     source ~/.bashrc  # or source ~/.zshrc
     ```
   - For Windows:
     Add `%USERPROFILE%\.dotnet\tools` to your PATH environment variable
